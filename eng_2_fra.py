...
def train_epoch(dataloader, encoder, decoder, encoder_optimizer,
    ...
    for data in dataloader:
        ...
        # take care of vanishing gradient
...
def train(train_dataloader, encoder, decoder, n_epochs, learning_rate=1E-03,
    ...
    encoder_optimizer = optim.Adam(encoder.parameter(), lr=learning_rate)
    decoder_optimizer = optim.Adam(decoder.parameter(), lr=learning_rate)
